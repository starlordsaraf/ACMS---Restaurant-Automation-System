...
class seatingChart extends Component {
   ...
   componentDidMount(){
    ...
    fetch(proxyurl+"https://u4gkjhxoe5.execute-api.us-east-2.amazonaws.com/Prod/restaurants/seating/4",{    //change to resid
        method: 'get'
    ...
    },360000)   //change to 20000 secs during finalization // 360000
  ...
  addtable(){
    ...
    //var username = sessionStorage.getItem("resId")   --use after login is done
    axios.put(proxyurl+"https://u4gkjhxoe5.execute-api.us-east-2.amazonaws.com/Prod/restaurants/seating/4",{
  ...
  deletetable(){
    const proxyurl = "https://cors-anywhere.herokuapp.com/";
    //var username = sessionStorage.getItem("resId")   --use after login is done
    axios.delete(proxyurl+"https://u4gkjhxoe5.execute-api.us-east-2.amazonaws.com/Prod/restaurants/seating/4",{data: {
 ...
 render() {
	...
	<div>
    <br/>
	 <h1 align="center">MANAGE TABLES</h1><br/>
...
class Button extends React.Component {
  ...
  handleClick(){
    ...
    if(this.state.button==true){
      axios.post(proxyurl+"https://u4gkjhxoe5.execute-api.us-east-2.amazonaws.com/Prod/restaurants/seating/block/4",{
        "tid":this.props.buttonprops.split("\n")[0].substring(1,)
      })
    }
    if(this.state.button==false){
      axios.post(proxyurl+"https://u4gkjhxoe5.execute-api.us-east-2.amazonaws.com/Prod/restaurants/seating/unblock/4",{
        "tid":this.props.buttonprops.split("\n")[0].substring(1,)
      })
    }
  }
